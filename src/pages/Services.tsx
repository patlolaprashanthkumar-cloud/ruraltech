  ...
  return (
    <div className="overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {serviceCategories.map((category, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white rounded-lg shadow-md hover:shadow-xl transition-all p-8 border border-border-color"
                >
                  <div className="flex items-center mb-6">
                    <div className={`${colors.bg} p-3 rounded-lg mr-4`}>
                      <category.icon className={colors.text} size={32} />
                    </div>
                    <h3 className="text-2xl font-bold text-deep-teal">{category.title}</h3>
                  </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-warm-white border border-border-color rounded-2xl p-12 text-deep-teal text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center bg-rural-green text-white px-8 py-3 rounded-lg font-semibold hover:bg-rural-green transition-all hover:scale-105 shadow-lg"
              >
                Partner Login
              </a>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-md p-8 text-center">
              <div className="text-4xl font-bold text-deep-teal mb-4">100+</div>
              <h3 className="text-xl font-bold text-deep-teal mb-2">Services Available</h3>
              <p className="text-secondary-text">
                Comprehensive portfolio covering all essential needs
              </p>
            </div>
            <div className="bg-white rounded-lg shadow-md p-8 text-center">
              <div className="text-4xl font-bold text-rural-green mb-4">24/7</div>
              <h3 className="text-xl font-bold text-deep-teal mb-2">Support Available</h3>
              <p className="text-secondary-text">
                Round-the-clock technical and business support
              </p>
            </div>
            <div className="bg-white rounded-lg shadow-md p-8 text-center">
              <div className="text-4xl font-bold text-primary-orange mb-4">Instant</div>
              <h3 className="text-xl font-bold text-deep-teal mb-2">Service Delivery</h3>
              <p className="text-secondary-text">
