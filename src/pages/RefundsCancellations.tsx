        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <div className="space-y-8">
              <div>
                <h2 className="text-2xl font-bold text-deep-teal mb-4">Overview</h2>
              ...
              <div>
                <h2 className="text-2xl font-bold text-deep-teal mb-4">Partner Registration Fees</h2>
              ...
              <div>
                <h2 className="text-2xl font-bold text-deep-teal mb-4">Cancellation Policy</h2>
                <p className="text-secondary-text leading-relaxed mb-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-deep-teal mb-4">Refund Eligibility</h2>
                <p className="text-secondary-text leading-relaxed mb-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-deep-teal mb-4">Non-Refundable Items</h2>
                <p className="text-secondary-text leading-relaxed mb-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-deep-teal mb-4">Refund Process</h2>
                <p className="text-secondary-text leading-relaxed mb-4">
                  To request a refund:
                </p>
                <ol className="list-decimal pl-6 space-y-2 text-secondary-text">
              ...
              <div>
                <h2 className="text-2xl font-bold text-deep-teal mb-4">Service Cancellation by Company</h2>
                <p className="text-secondary-text leading-relaxed mb-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-deep-teal mb-4">Transaction Refunds</h2>
                <p className="text-secondary-text leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl font-bold text-deep-teal mb-4">Wallet Balance</h2>
                <p className="text-secondary-text leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl font-bold text-deep-teal mb-4">Force Majeure</h2>
                <p className="text-secondary-text leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl font-bold text-deep-teal mb-4">Contact for Refunds</h2>
                <p className="text-secondary-text leading-relaxed">
